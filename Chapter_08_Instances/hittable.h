...
// Rotation isn’t quite as easy to understand or generate the formulas for. 
// A common graphics tactic is to apply all rotations about the x, y, and z axes. 
// These rotations are in some sense axis-aligned. 
// First, rotate by theta about the z-axis. 
// That will be changing only x and y, and in ways that don’t depend on z. 
